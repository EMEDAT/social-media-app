...
const Profile = () => {
  ...
  // Add state for followers and following
  ...
  const handleFollowClick = () => {
    ...
    // If the user is currently following the profile user, decrease the followers count
    if (isFollowing) {
      setFollowers(followers - 1);
    } 
    // If the user is not currently following the profile user, increase the followers count
    else {
      setFollowers(followers + 1);
    }
  };
